...
engine = create_engine('postgresql://antonio:password@localhost/red30')
...
with engine.connect() as connection:
    ...
    # Update
    update_statement = sales_table.update().where(sales_table.c.order_num==1105910).values(quantity=4, order_total=55)
